...
output_file="${1:-$output_dir/slovopad-standalone.zip}"
...
cd "$project_dir"
zip -q -r -FS "$output_file" index.html styles.css vendor/game-style-engine.css game.js word-bank.js sounds.js
